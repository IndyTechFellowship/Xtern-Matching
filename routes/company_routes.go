...
func GetCompanyRoutes() *mux.Router {
	...
	router.HandleFunc("/company/getCompanyByName", handlers.GetCompanyByName).Methods("POST").Name("GetCompanyByName")
	router.HandleFunc("/company/getCurrentCompanyByName", handlers.GetCurrentCompanyByName).Methods("POST").Name("GetCurrentCompanyByName") //use this one
