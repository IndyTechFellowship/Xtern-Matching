    ...
    app.config(function($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('techpoint', {
                url:"/techpoint",
                abstract: true,
                templateUrl: "src/partials/techpoint/techpoint.html",
                controller: 'TechPointMain'
            })
            .state('techpoint.dashboard',{
                url:"/dashboard",
                templateUrl: "src/partials/techpoint/techpoint.missionControl.html",
            ...
            .state('techpoint.profile',{
                url:"/profile/:_id",
                templateUrl: "src/partials/studentProfile.html",
                //resolve: { authenticate: authenticate }
            ...
            .state('techpoint.login', {
                url:"/login",
                templateUrl: "src/partials/techpoint/techpoint.login.html",
            ...
            .state('company', {
                url:"/company",
                abstract: true,
                templateUrl: "src/partials/company/company.html",
                controller: 'CompanyMain'
            })
            .state('company.dashboard',{
                url:"/dashboard",
                templateUrl: "src/partials/company/company.missionControl.html",
                //resolve: { authenticate: authenticate }
           ...
           .state('company.profile',{
            ...
            .state('company.login', {
                url:"/login",
                templateUrl: "src/partials/company/company.login.html",
