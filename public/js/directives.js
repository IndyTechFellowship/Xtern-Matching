angular.module('Xtern')
    .directive('studentProfileComment', function() {
        return {
            restrict: 'E',
            templateUrl: '../src/partials/components/comment.html',
            // template: '<p>test</p>'
    ...
    .directive('techLabels', function () {
        return {
            ...
            //     labels: labels
            // },
            templateUrl: '../src/partials/components/techLabels.html',
    ...
    .directive('simpleFilter', function () {
        return {
            ...
            templateUrl: '/src/partials/components/simpleMSFilter.html'
        };
    })
    .directive('toggleFilter', function () {
        return {
            ...
            templateUrl: '/src/partials/components/toggleMSFilter.html'
        };
    })
    .directive('missionControl', function () {// until a better name arrives
        return {
            ...
            templateUrl: '/src/partials/components/missionControlPage.html'
        };
    });